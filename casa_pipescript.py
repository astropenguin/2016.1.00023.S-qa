...
context = h_init()
context.set_state('ProjectSummary', 'proposal_code', '2016.1.00023.S')
context.set_state('ProjectSummary', 'piname', 'unknown')
context.set_state('ProjectSummary', 'proposal_title', 'unknown')
context.set_state('ProjectStructure', 'ous_part_id', 'X1010083969')
context.set_state('ProjectStructure', 'ous_title', 'Undefined')
context.set_state('ProjectStructure', 'ppr_file', '/opt/dared/opt/c5r1/mnt/dataproc/2016.1.00023.S_2018_03_09T13_37_06.344/SOUS_uid___A001_X87d_X495/GOUS_uid___A001_X87d_X496/MOUS_uid___A001_X87d_X497/working/PPR_uid___A001_X87d_X498.xml')
context.set_state('ProjectStructure', 'ps_entity_id', 'uid://A001/X3ab/X3f')
context.set_state('ProjectStructure', 'recipe_name', 'hifa_calimage')
context.set_state('ProjectStructure', 'ous_entity_id', 'uid://A001/X3ab/X3b')
context.set_state('ProjectStructure', 'ousstatus_entity_id', 'uid://A001/X87d/X497')
try:
    hifa_importdata(vis=['uid___A002_Xc27dd7_X2fc3', 'uid___A002_Xc27dd7_X6983', 'uid___A002_Xc27dd7_X6c8e', 'uid___A002_Xc2b007_X877', 'uid___A002_Xc8592e_Xaea3', 'uid___A002_Xc89480_X8c7d', 'uid___A002_Xc96463_X1646', 'uid___A002_Xc96f17_X113a'], session=['session_1', 'session_2', 'session_2', 'session_3', 'session_4', 'session_5', 'session_7', 'session_8'])
